...
#     "I recommend contacting support for this particular query."
# ]
...
#     "Account deletion requests can be submitted via email.",
#     "Our service includes advanced security measures for your data."
# ] + [
